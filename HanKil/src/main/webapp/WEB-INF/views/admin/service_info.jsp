...
<script type="text/javascript">
	...
	window.onload=function(){
		selectValue(document.getElementsByName("rank"), '${service_info.rank}');
	    selectValue(document.getElementsByName("use_yn"),'${service_info.use_yn}');
	    selectValue(document.getElementsByName("secret_yn"), '${service_info.secret_yn}');
	    selectValue(document.getElementsByName("category_seq"), '${service_info.category_seq}');
	    
	    selectOpt();
	    selectValue(document.getElementsByName("product_seq"), '${service_info.product_seq}');
	};
</script>
    ...
    <form name="docForm" method="post">
     ...
     <table width="700" border="0" cellspacing="2" cellpadding="1">
       ...
       <tr> 
         ...
         <td style="padding-left:10">
         	<input name="service_seq" value="${service_info.service_seq}" style="display: none;"/>
         	<input name="user_seq" value="${service_info.user_seq}" style="display: none;"/>
         	<input name="ref_seq" value="${service_info.ref_seq}" style="display: none;"/>
         	<input name="reply_depth" value="${service_info.reply_depth}" style="display: none;"/>
         	<input name="reply_num" value="${service_info.reply_num}" style="display: none;"/>
         	<input name="reply_yn" value="${service_info.reply_yn}" style="display: none;"/>
         	<input id="title" name="title" type="text" class="darkgray12" maxlength="120" style="WIDTH: 130px; HEIGHT: 19px; border:solid 1 #cccccc" value="${service_info.title}" >
	  </td>
       </tr>
       <tr> 
         <td height="1" bgcolor="#67AEB8"></td>
       ...
       <tr> 
         ...
         <td style="padding-left:10">
         	<textarea id="content" name="content" rows="5" class="darkgray12" style="WIDTH: 100%; border:solid 1 #cccccc" maxlength="1000">${service_info.content}</textarea>
	  </td>
       </tr>
       <tr> 
         <td height="1" bgcolor="#67AEB8"></td>
       ...
       <tr> 
         ...
         <td style="padding-left:10">
         	<input id="name" name="name" type="text" class="darkgray12" maxlength="120" style="WIDTH: 130px; HEIGHT: 19px; border:solid 1 #cccccc" value="${service_info.user_name}" >
	  	</td>
       </tr>
       <tr> 
         <td height="1" bgcolor="#67AEB8"></td>
       ...
       <tr> 
         ...
         <td style="padding-left:10">
         	<input name="count" type="text" class="darkgray12" maxlength="120" style="WIDTH: 130px; HEIGHT: 19px; border:solid 1 #cccccc" value="${service_info.count}" >
	  	</td>
       </tr>
       <tr> 
         <td height="1" bgcolor="#67AEB8"></td>
       ...
       <tr> 
         ...
         <td style="padding-left:10">
         	<input id="passwd" name="passwd" type="password" class="darkgray12" maxlength="4" style="WIDTH: 130px; HEIGHT: 19px; border:solid 1 #cccccc" value="${service_info.passwd}" >
...
<table width="700" border="0" cellspacing="0" cellpadding="0">
	<tr> 
		<td align="right" >
			<c:if test="${service_info.reply_yn == 'n'}">
				<a href="./service_reply.do?service_seq=${service_info.service_seq}"><img src="./images/btn_reply.jpg" border="0"></a>&nbsp;
			</c:if>
			<a href="JavaScript:save(document.docForm, 'service_modify_action.do');"><img src="./images/btn_save.gif" border="0"></a>&nbsp;
