...
<script type="text/javascript">
	...
	var finalChkId = '';
	var originalId = '${account_info.user_id}';
	
	function duplicationAdminId(){
		
		var user_id = document.getElementsByName("user_id")[0].value;
		
		if(originalId==user_id){
			alert('동일한 아이디입니다.');
			idChk = 'Y';
			finalChkId = user_id;
...
<tr>
    ...
    <form name="docForm" method="post">
     <table width="700" border="0" cellspacing="0" cellpadding="0">
       <tr>                 
         <td height="25"  align="left" class="darkgray12b" style="padding-left:2">[ 계정 조회 ]</td>
       </tr>
     </table>
	...
	<tr> 
       ...
       <tr> 
         ...
         <td style="padding-left:10">
         	<input name="user_seq" value="${account_info.user_seq}" style="display: none;"/>
         	<input name="user_id" type="text" class="darkgray12" maxlength="15" style="WIDTH: 130px; HEIGHT: 19px; border:solid 1 #cccccc" value="${account_info.user_id}" >
       ...
       <tr> 
         ...
         <td style="padding-left:10">
         	<input name="user_passwd" type="password" class="darkgray12" maxlength="15" style="WIDTH: 130px; HEIGHT: 19px; border:solid 1 #cccccc" value="${account_info.user_passwd}">
	  </td>
       </tr>
       <tr> 
         <td height="1" bgcolor="#67AEB8"></td>
       ...
       <tr> 
         ...
         <td style="padding-left:10">
         	<input name="user_passwd_confirm" type="password" class="darkgray12" maxlength="15" style="WIDTH: 130px; HEIGHT: 19px; border:solid 1 #cccccc" value="${account_info.user_passwd}">
	  </td>
       </tr>
       <tr> 
         <td height="1" bgcolor="#67AEB8"></td>
       ...
       <tr> 
         ...
         <td style="padding-left:10">
         	<input name="user_name" type="text" class="darkgray12" maxlength="60" style="WIDTH: 130px; HEIGHT: 19px; border:solid 1 #cccccc" value="${account_info.user_name}">
	  </td>
       </tr>
       <tr> 
         <td height="1" bgcolor="#67AEB8"></td>
       ...
       <tr> 
         <td align="right" bgcolor="F8F6F6" style="padding-right:10">권한</td>
         <td style="padding-left:10">
         	<select class="darkgray12" id="user_rank" name="user_rank">
					...
					<c:choose>
						...
						<c:otherwise>
							<c:choose>
								<c:when test="${account_info.user_name == 'admin'}">
       ...
       <tr> 
         ...
         <td style="padding-left:10">
         	<select class="darkgray12" id="use_yn" name="use_yn">
         		<c:choose>
         			<c:when test="${account_info.use_yn == 'y'}">
...
<table width="700" border="0" cellspacing="0" cellpadding="0">
	<tr> 
		<td align="right" >
			<a href="JavaScript:save(document.docForm, 'admin_modify_action.do');"><img src="./images/btn_save.gif" border="0"></a>&nbsp;
