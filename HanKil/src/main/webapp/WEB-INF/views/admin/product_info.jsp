...
<script type="text/javascript">
	...
	window.onload=function(){
		selectValue(document.getElementsByName("category_seq"), '${product_info.category_seq}');
	    selectValue(document.getElementsByName("use_yn"),'${product_info.use_yn}');
	};
</script>
...
<tr>
    ...
    <form name="docForm" method="post">
     <table width="700" border="0" cellspacing="0" cellpadding="0">
       <tr>                 
         <td height="25"  align="left" class="darkgray12b" style="padding-left:2">[ 제품조회 ]</td>
       </tr>
     </table>
     <table width="700" border="0" cellspacing="2" cellpadding="1">
       ...
       <tr> 
         ...
         <td style="padding-left:10">
         	<input name="product_seq" value="${product_info.product_seq}" style="display: none;"/>
         	<input id="product_name" name="product_name" type="text" class="darkgray12" maxlength="120" style="WIDTH: 130px; HEIGHT: 19px; border:solid 1 #cccccc" value="${product_info.product_name}" >
	  	</td>
       </tr>
       <tr> 
         <td height="1" bgcolor="#67AEB8"></td>
       ...
       <tr> 
         ...
         <td style="padding-left:10">
         	<input name="product_info" type="text" class="darkgray12" maxlength="120" style="WIDTH: 130px; HEIGHT: 19px; border:solid 1 #cccccc" value="${product_info.product_info}" >
	  </td>
       </tr>
       <tr> 
         <td height="1" bgcolor="#67AEB8"></td>
...
<table width="700" border="0" cellspacing="0" cellpadding="0">
	<tr> 
		<td align="right" >
			<a href="JavaScript:save(document.docForm, 'product_modify_action.do');"><img src="./images/btn_save.gif" border="0"></a>&nbsp;
