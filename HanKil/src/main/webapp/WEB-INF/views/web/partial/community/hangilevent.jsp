		...
		<div class="depth_menu">
			<div>
				...
				<ul class="depth06">
					...
					<li class="hangilevent"><a class="view" href="../community/hangilevent.do"><span class="hide">한길이벤트</span></a></li>
					<li class="notice"><a href="../community/notice.do"><span class="hide">참여게시판</span></a></li>
				</ul>
			</div>
		</div>
